/* eslint-disable react-refresh/only-export-components -- shadcn primitive, same shape as button.tsx */
...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        "flex items-center gap-2 rounded-sm border bg-muted px-2.5 text-sm font-medium shadow-soft [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
