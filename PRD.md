...
| F4.3.49 | The theme drives the whole Terminal window like Warp — title bar, rail, panes — with the wallpaper (opacity, blur, fit) behind everything; window opacity 50-100 and acrylic / mica / vibrancy backdrop on a transparent window; cursor style, blink and padding | Must Have | Done |
